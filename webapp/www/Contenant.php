 ...
 */
    ...
    class Inventaire_ContenantPage extends Page
    {
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'ID_Contenant', 'ID_Contenant', $this->RenderText('ID Contenant')),
                new FilterColumn($this->dataset, 'Nom', 'Nom', $this->RenderText('Nom')),
                new FilterColumn($this->dataset, 'Type', 'Type', $this->RenderText('Type'))
            );
        }
        ...
        {
            $main_editor = new TextEdit('id_contenant_edit');
        ...
        {
            //
            // View column for ID_Contenant field
            //
            $column = new NumberViewColumn('ID_Contenant', 'ID_Contenant', 'ID Contenant', $this->dataset);
    ...
    try
    {
        $Page = new Inventaire_ContenantPage("Inventaire_Contenant", "Contenant.php", GetCurrentUserGrantForDataSource("Inventaire.Contenant"), 'UTF-8');
        $Page->SetTitle('Contenant');
        $Page->SetMenuLabel('Contenant');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("Inventaire.Contenant"));
